...
const data = [
  ...
  { calendarimage: "images/img_megaphone.svg", pressreleasetext: "2023 Third-Quarter Earning Transcript" },
  { calendarimage: "images/img_user.svg", pressreleasetext: "Q323 Other Financial Disclosures" },
];
const data1 = [
  { text: "Reconciliation and Financial Package", downloadbuttontext: "Download PDF" },
...
const data2 = [
  ...
  { webcastone: "images/img_close_black_900_01.svg", webcasttwo: "Presentation" },
  { webcastone: "images/img_close_black_900_01_32x32.svg", webcasttwo: "Press Release" },
];
        ...
        <div className="mt-[37px] flex flex-col items-center">
              ...
              <div className="container-xs relative z-[1] flex flex-col items-end md:p-5">
                <div className="flex w-[12%] flex-col gap-[7px] md:w-full">
                  <div className="flex flex-wrap items-center gap-[7px] self-start">
                    <Text size="s" as="p" className="self-end text-right !font-medium !text-teal-700">
                      NYSE : TMO
                    </Text>
                  ...
                  <Text size="xs" as="p" className="leading-5 !text-gray-700_cc">
                    <>
                ...
                <div className="relative h-[384px] self-stretch md:h-auto">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-[384px] w-full items-center justify-between gap-5 bg-[url(/public/images/img_group_83.png)] bg-cover bg-no-repeat md:relative md:h-auto md:flex-col">
                    <div className="flex h-[384px] w-[59%] items-center justify-center bg-[url(/public/images/img_vector.png)] bg-cover bg-no-repeat px-14 py-[100px] md:h-auto md:w-full md:p-5">
                      <Text size="2xl" as="p" className="w-[81%] !font-normal leading-9 !text-white-A700">
          ...
          <div className="mx-auto mt-[77px] flex w-full max-w-[1241px] flex-col items-start gap-[58px] md:p-5 sm:gap-[29px]">
            ...
            <div className="flex gap-[15px] self-stretch md:flex-col">
              <div className="flex flex-1">
                <div className="flex w-full flex-col items-start">
                  <Button size="lg" shape="round" className="w-full !rounded-[3px] font-medium sm:px-5">
                  ...
                  <div className="mt-[33px] flex items-start gap-[34px] self-stretch sm:flex-col">
                    <div className="relative h-[310px] flex-1 md:h-auto sm:w-full sm:flex-none sm:self-stretch">
                      <Text size="xl" as="p" className="!font-medium !text-gray-800">
                        End markets
                      </Text>
                      <div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[310px] w-full">
                        <CircularProgressbar
                          strokeWidth={8}
                          value={12}
                          styles={{
                            trail: { stroke: "#664fa3" },
                            path: { strokeLinecap: "square", transformOrigin: "center", transform: "rotate(208deg)" },
                          }}
                          className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[290px] w-[94%]"
                        />
                        <CircularProgressbar
                          strokeWidth={2}
                          value={12}
                          ...
                          className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[310px] w-full"
                        />
                        <CircularProgressbar
                          strokeWidth={8}
                          value={12}
                          styles={{
                            trail: { stroke: "#664fa3" },
                            path: { strokeLinecap: "square", transformOrigin: "center", transform: "rotate(255deg)" },
                          }}
                          className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[290px] w-[94%]"
                        />
                        <CircularProgressbar
                        ...
                        <CircularProgressbar
                          strokeWidth={8}
                          value={16}
                          styles={{ trail: { stroke: "#664fa3" }, path: { strokeLinecap: "square" } }}
                          className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[290px] w-[94%]"
                        />
                        <CircularProgressbar
                          strokeWidth={2}
                          value={16}
                          styles={{ trail: { stroke: "#b5bd0087" }, path: { strokeLinecap: "square" } }}
                          className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[310px] w-full"
                        />
                      </div>
                    </div>
                    <div className="flex w-[43%] flex-col gap-[26px] sm:w-full">
                      <div className="flex items-start gap-[11px]">
                        ...
                        <Text as="p" className="w-[95%] !font-normal leading-6 !text-gray-800">
                          Enabling advanced materials to power the digital economy and the clean energy transition
                        </Text>
                      </div>
              ...
              <div className="flex w-[27%] flex-col items-center gap-[34px] md:w-full">
                <Button size="lg" shape="round" className="w-full !rounded-[3px] font-medium sm:px-5">
                ...
                <div className="relative h-[290px] w-[87%] md:h-auto">
                  <div className="mb-[75px] flex w-[46%] flex-col items-center gap-4">
                    ...
                    <Text size="2xl" as="p" className="w-full text-center leading-8">
                      ...
                      <span className="text-base font-normal text-gray-900">Revenue</span>
                    </Text>
                  </div>
                  <CircularProgressbar
                    strokeWidth={8}
                    value={16}
                    styles={{ trail: { stroke: "#664fa3" }, path: { strokeLinecap: "square" } }}
                    className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[290px] w-full"
                  />
                </div>
              </div>
              <div className="mb-2.5 flex w-[20%] flex-col justify-center gap-3.5 md:mb-0 md:w-full">
              ...
              <div className="flex w-[24%] flex-col gap-8 md:w-full">
                <div className="flex flex-col gap-[34px]">
                  ...
                  <div className="relative h-[290px] md:h-auto">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[290px] w-full">
                      <CircularProgressbar
                        strokeWidth={8}
                        value={24}
                        styles={{
            ...
            <Text size="s" as="p" className="!text-gray-800_7f">
              NOTE : Revenue and percentage based on unaudited LTM through Q3 2023
            </Text>
          </div>
            ...
            <div className="container-xs flex flex-col items-start gap-[47px] md:p-5">
              ...
              <div className="flex w-[92%] gap-[141px] md:w-full md:flex-col">
                <div className="flex flex-col items-start">
                  <Text size="6xl" as="p" className="!font-medium !text-white-A700">
                    <span className="text-3xl text-white-A700">$10.6</span>
                    <span className="text-white-A700">&nbsp;</span>
                    <span className="text-xl font-normal text-white-A700">billion</span>
                  </Text>
                ...
                <div className="flex w-[18%] items-center gap-[25px] md:w-full">
                  ...
                  <div className="flex flex-1 flex-col items-start gap-0.5">
                    ...
                    <Text as="p" className="w-full !font-normal leading-6 !text-teal-100">
                      <>
          ...
          <div className="container-xs mt-[78px] flex flex-col items-start gap-11 md:p-5">
              ...
              <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                ...
                <div className="flex flex-col items-start gap-10">
                  ...
                  <div className="flex flex-col items-start gap-[25px]">
                    <div className="flex items-center self-center bg-gray-100_01 pr-6 sm:flex-col sm:pr-5">
                      ...
                      <Text as="p" className="ml-4 sm:ml-0">
                        <span className="text-gray-900">Thermo Fisher Scientific :&nbsp;</span>
                        <span className="font-normal text-gray-900">First Quarter 2023 Results</span>
                      </Text>
                      <Img
                    ...
                    <div className="flex items-center gap-[18px]">
                      ...
                      <Img src="images/img_arrow_right_red_a700.svg" alt="arrowright" className="h-[16px] self-end" />
                    </div>
                    <div className="flex items-center gap-[18px]">
                      <Text as="p" className="!font-normal">
                        2023 Q1 Results
                  ...
                  <div className="flex py-[7px] pr-[7px]">
                    <Text as="p" className="self-start tracking-[0.64px] !text-red-A700">
            ...
            <div className="flex items-start justify-center gap-10 self-stretch bg-indigo-900 p-4 md:flex-col">
              <Text size="xl" as="p" className="mt-5 !font-medium">
                ...
                <span className="text-gray-900">&nbsp;</span>
                <span className="font-normal text-white-A700">Investor Day Materials</span>
              </Text>
              <div className="flex flex-1 gap-1 md:flex-col md:self-stretch">
                {data2.map((d, index) => (
                  ...
                  >
                    <Img src={d.webcastone} alt="webcast" className="ml-1.5 h-[32px] w-[32px]" />
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="mt-[34px] flex flex-col items-start gap-6">
                    <div className="flex items-start gap-4">
                      ...
                      <Img src="images/img_arrow_right_red_a700.svg" alt="arrowright" className="h-[16px]" />
                    </div>
                    <div className="flex items-start gap-4">
            ...
            <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
              <div className="flex w-[26%] flex-col items-start gap-[21px] md:w-full">
                ...
                <Text as="p" className="w-full !font-normal leading-6">
                  ...
                  <span className="text-red-A700">investorrelations@thermofisher.com</span>
                </Text>
              </div>
              <div className="flex w-[26%] flex-col items-start gap-[19px] md:w-full">
                ...
                <Text as="p" className="w-full !font-normal leading-6">
                  <span className="text-gray-900">
                    <>
                      American Stock Transfer Share holder Inquiries Operations <br />
                      Center 620115th <br />
                  ...
                  <span className="text-gray-900">Corporate Website:&nbsp;</span>
